			...
			<div class="col-lg-8">
				...
				<form action="/update" method="POST">
					...
					<table class="table">
						...
						<tr>
							<td>제목 :</td>
							<td><input name="TH_BOARD_TITLE" value="${detail.TH_BOARD_TITLE }"></td>
						</tr>
						<tr>
							<td>내용 :</td>
							<td><textarea rows="9" cols="100" name="TH_BOARD_CONTENTS" value="${detail.TH_BOARD_CONTENTS}" >${detail.TH_BOARD_CONTENTS}</textarea></td>
						</tr>
						<tr>
							<td>작성일 :</td>
					...
					<div style="display: inherit;">
						<button class="btn btn-primary" type="submit" style="margin-right: 10px;">update</button>
					</div>
					</form>
				</div>
			</div>
